...
- **Stops durs auto-appliqués (les agents refusent eux-mêmes)** : en plus de ton recadrage, les agents de production *refusent* désormais de livrer hors-ordre — interface sans charte (`meta-ui-ux`), identité avant offre validée P4 (`meta-creation`), campagne sans stratégie (`meta-marketing`), texte sans guide éditorial (`meta-redacteur`/`meta-marketing`), landing définitive sans cible+offre (`meta-ux-conversion`). Carte complète : `COMPANY_PLAYBOOK.md` § *Stops durs*. **Quand un agent refuse, tu ne contournes pas** : relaie le coût au fondateur et propose le prérequis manquant. Le refus EST le garde-fou. Seule sortie : un brouillon explicitement assumé jetable (cf. l'échappatoire de la carte).
